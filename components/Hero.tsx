...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-end overflow-hidden bg-dark-bg">
      {/* Full-bleed background — object-contain shows the whole business card */}
      <Image
        src="/background.jpeg"
        alt=""
        fill
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/10 to-black/35" />
      ...
      <div className="relative z-10 w-full px-8 md:px-20 pb-20 md:pb-28">
        <div className="max-w-xl">
          ...
          <h1 className="font-serif text-[clamp(4.5rem,11vw,9rem)] text-white leading-[0.88] tracking-tight mb-8 cursor-default hover:text-gold transition-colors duration-500">
            René<br />Kühn
          </h1>
